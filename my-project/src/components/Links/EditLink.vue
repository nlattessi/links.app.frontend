			...
			<div class="card card-block">
				...
				<form role="form" v-on:submit.prevent="update">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="title" v-model="editLink.title" :disabled="editing" />
					</div>

					<div class="form-group">
						<label for="url">Url</label>
						<input type="text" class="form-control" id="url" v-model="editLink.url" :disabled="editing" />
					</div>

					<div class="form-group">
						<label for="category">Category</label>
						<select class="form-control" v-model="editLink.category" :disabled="editing">
              ...
              <template v-for="category in categories">
                <option value="{{category.id}}">{{category.name}}</option>
					...
					<button type="submit" class="btn btn-primary btn-block" :disabled="editing">Save link</button>
