			...
			<div class="card card-block">
				...
				<form role="form" v-on:submit.prevent="update">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="name" v-model="editCategory.name" :disabled="editing" tabindex="1" />
					</div>

					<button type="submit" class="btn btn-primary btn-block" :disabled="editing" tabindex="2">Save category</button>
